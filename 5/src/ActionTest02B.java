...
public class ActionTest02B extends JFrame {
  ...
  class CheckAction extends AbstractAction{
    ...
    public void actionPerformed( ActionEvent e ){
      JCheckBox cb = (JCheckBox)e.getSource(); // イベントからイベントソースを得る
      String msg;
      if( cb.isSelected() ) msg = "選択されました"; // isSelected() の結果によって
      else                  msg = "選択解除されました";
      System.out.println( (String)getValue( Action.NAME ) +" が " + msg ); // チェックボックスの名前を得る
    }
  }
}