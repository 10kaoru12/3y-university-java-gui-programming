...
public class MouseEventTest02 extends JFrame {
  ...
  public MouseEventTest02( String title ){
    ...
    panel.addMouseListener( new MouseCheck() ); //コンテントペインにリスナを登録
  }
  class MouseCheck implements MouseListener { // リスナの定義
    public void mousePressed( MouseEvent e ){ // イベントごとにメソッドを実装する
