...
public class MouseWheelEventTest01 extends JFrame {
  ...
  public MouseWheelEventTest01( String title ){
    ...
    panel.addMouseWheelListener( new MouseCheck() ); // リスナの登録
  }

  class MouseCheck implements MouseWheelListener { // リスナの実装
    public void mouseWheelMoved( MouseWheelEvent e ){ // ホイールのイベント
      System.out.println( "-----------------" );
