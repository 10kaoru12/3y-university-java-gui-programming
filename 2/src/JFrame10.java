...
public class JFrame10 extends JFrame {
    ...
    public JFrame10( String title ){
        ...
        addComponentListener( new ComponentEventHandler() ); // コンポーネントリスナの設定
        addWindowListener( new WindowEventHandler() ); // ウィンドウリスナの設定
        setLocation(100,100);
        setSize(500, 300);
    ...
    class ComponentEventHandler implements ComponentListener { // コンポーネントリスナ
    ...
    class WindowEventHandler implements WindowListener { // ウィンドウリスナ
