...
public class DialogTest07 extends JFrame {
  ...
  class Dialog07 extends AbstractAction {
    ...
    public void actionPerformed( ActionEvent e ){
      ...
      JList list = new JList( choice ); // リストの生成

      JRadioButton bt1 = new JRadioButton( "ラジオボタン" ); // ラジオボタン (作っただけ)
      JCheckBox    bt2 = new JCheckBox( "チェックボックス" ); // チェックボックス (作っただけ)
      Object[] msg = { list, bt1, bt2 }; // 配列に入れる
