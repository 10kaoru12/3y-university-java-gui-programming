...
class JFileChooserTest02 extends JFrame {
  ...
  class LoadImageFile extends AbstractAction {
    ...
    public void actionPerformed( ActionEvent e ){
      ...
      fileChooser.setFileFilter( new ImageFileFilter() ); // フィルタを設定
  ...
  class ImageFileFilter extends javax.swing.filechooser.FileFilter { // フィルタの定義
    String[] extensions = { "gif", "jpg" }; // 拡張子を指定
